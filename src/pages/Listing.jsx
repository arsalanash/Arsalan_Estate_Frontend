                            ...
                            {currentUser &&
                                listing.userRef === currentUser._id && (
                                    <div className="flex gap-2 w-full">
                                        ...
                                        >
                                            <button 
                                            className="text-green-700 uppercase w-[200px] max-w-[200px] bg-slate-200 text-center p-1 rounded-md">
                                                Edit
                                            </button>
                                        </Link>
                                        <button
                                            onClick={handleDelete}
                                            className="text-red-700 uppercase w-full max-w-[200px] bg-slate-200 text-center p-1 rounded-md"
                                        >
